...
\begin{figure}[htbp]
    ...
    \begin{tabular}{c c}
        ...
        \multicolumn{2}{c}{
            ...
            \node (B) [state, accepting] [right of=A] {$\{L\}$};
            \node (C) [state, accepting] [right of=B] {$\{H\}$};
            \node (D) [state, accepting] [below of=B] {$\{H\}$};
